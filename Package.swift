...
let package = Package(
  name: "oh-my-display", platforms: [.macOS(.v14)],
  products: [
    .library(name: "OMDCore", targets: ["OMDCore"]), .executable(name: "OhMyDisplay", targets: ["OhMyDisplay"]), .executable(name: "omd", targets: ["omd"]),
